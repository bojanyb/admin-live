    ...
    >
      ...
      <div class="select-menu-wrapper">
        <template v-if="opt.length > 0">
          <ul>
            <li v-for="(item, index) in opt" :key="index" class="option" :class="{ selected: item[labelKey] + '' === selected + '' }" @click="selectHandle(item)">
              {{ item[labelKey] }}
            </li>
            <li v-if="!showInput" class="option" @click="showInputHandle">
              其他
            </li>
            <li v-if="allowCreate && showInput">
              <template v-if="type === 'number'">
                ...
                <el-input-number
                  ...
                  :min="min"
                  class="text-left"
                  @keyup.enter.native="submitOption"
                  @blur="submitOption"
                />
              </template>
              <template v-else>
