...
export default {
	...
	components: {
		menuComp,
		giftListPage: () => import("./components/pizzaComp/gift-list.vue"),
		cpRankPage: () => import("./components/pizzaComp/make-list.vue"),
		loveTreePage: () => import("./components/pizzaComp/exchange-list.vue"),
