  ...
  <div class="app-container">
    ...
    <el-dialog :title="editTitle" :visible.sync="editPop">
      <el-form :model="popForm">
        ...
        <el-form-item label="消费钻石总数" :label-width="formLabelWidth">
          <el-col :span="17">
            <el-input
              v-model="popForm.diamond_total"
              v-input-limit="0"
              style="width: 335px;"
              placeholder="请输入收入消费钻石总数"
              clearable
              autocomplete="off"
            />
          </el-col>
        </el-form-item>
        <el-form-item label="总支出" :label-width="formLabelWidth">
          <el-col :span="17">
            <el-input
              v-model="popForm.spending"
              v-input-limit="0"
              style="width: 335px;"
              placeholder="请输入总支出"
              clearable
...
export default {
  ...
  methods: {
    ...
    handleChange() {
      ...
      if (this.popForm.diamond_total == '' && this.popForm.diamond_total !== 0) {
        this.$message.error('消费钻石总数不能为空')
        return
      }
      if (this.popForm.spending == '' && this.popForm.spending !== 0) {
        this.$message.error('总支出不能为空')
        return
      }
