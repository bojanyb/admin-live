	...
	<div class="app-container">
		...
		<el-table ref="multipleTable" v-loading="listLoading" :data="list" element-loading-text="拼命加载中" border fit
			...
			<el-table-column label="操作" align="center" width="180">
				<template slot-scope="scope">
					<el-button type="primary" v-if="scope.row.status == '1'" @click="handleEdit(scope.row)">修改
					</el-button>
					<el-button type="danger" v-if="scope.row.status == '1'" @click="handleDel(scope.row)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
	...
	export default {
		...
		methods: {
			...
			handleDelSubmit() {
				...
				for (let item in this.delSource) {
