  ...
  <div class="app-container">
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters" @keyup.enter.native="giftlist()">
        ...
        <el-form-item>
          <el-button type="primary" @click="giftlist">查询</el-button>
      ...
      <el-table-column label="礼物图片" prop="gift_genre" align="center">
        <template slot-scope="scope">
          <el-image
            ...
            @click="showImg(scope.row.gift_gif)"
          />
        </template>
      </el-table-column>
    ...
    <el-dialog :title="editTitle" :visible.sync="editPop" @close="handleCancel">
      <el-form :model="popForm">
        <el-form-item label="礼物名" :label-width="formLabelWidth">
          <el-col :span="17">
            <el-input
              v-model="popForm.gift_name"
              style="width: 335px;"
              placeholder="请输入礼物名"
              clearable
              autocomplete="off"
        ...
        <el-form-item label="礼物特效" :label-width="formLabelWidth">
          <el-upload
            ...
            action="#"
            :show-file-list="false"
            :on-change="imgSvgPreview"
            :auto-upload="false"
          >
            <svgaplayer
              v-if="imageSvgUrl.indexOf('.svga') > -1"
              :data-title="imageSvgUrl"
              :height="178"
              :width="178"
        ...
        <el-form-item label="钻石价格" :label-width="formLabelWidth">
          <el-input
            v-model="popForm.gift_diamond"
            v-input-limit="0"
            style="width: 335px;"
            placeholder="请输入钻石价格"
            clearable
        ...
        <el-form-item label="平台分成" :label-width="formLabelWidth">
          <el-input
            v-model="popForm.gift_rateText"
            v-input-limit="2"
            style="width: 335px;"
            placeholder="请输入平台分成(0~100)"
            clearable
            autocomplete="off"
            @input="changeDiamond"
            @change="numberChange(arguments[0],100,'gift_rateText')"
          />
          <span style="margin-left: 1%;"> %</span>
          <div>平台喵粮 {{ diamondNum }} 个</div>
        </el-form-item>
        <el-form-item label="礼物生效时间" :label-width="formLabelWidth">
          <el-date-picker
            v-model="popForm.start_timeText"
            style="width: 335px;"
            type="datetime"
            placeholder="选择时间"
        ...
        <el-form-item label="礼物过期时间" :label-width="formLabelWidth">
          <el-date-picker
            v-model="popForm.end_timeText"
            style="width: 335px;"
            type="datetime"
            placeholder="选择时间"
            :picker-options="pickerBeginDateBefore"
        ...
        <el-form-item v-if="popForm.type == 'Edit'" label="状态" :label-width="formLabelWidth">
        ...
        <el-form-item label="排序" :label-width="formLabelWidth">
          <el-input
            ...
            clearable
            autocomplete="off"
            @change="numberChange(arguments[0],65535,'sort')"
          />
        </el-form-item>
        <el-form-item label="礼物说明" :label-width="formLabelWidth">
          <el-input
            v-model="popForm.gift_desc"
            type="textarea"
            :rows="5"
            style="width: 335px;"
            placeholder="请输入礼物说明"
