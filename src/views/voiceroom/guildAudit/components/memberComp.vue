        ...
        // },
        {
          ...
          render: (h, params) => {
            ...
            return h(
              ...
              {
                style: {
                  display: this.permissionArr.includes(
                    "Guild@changePrivateChat"
                  )
                    ? "unset"
                    : "none",
                },
            ...
            return h("div", [
              h(
                "el-button",
                {
                  ...
                  on: {
                    click: () => {
                      this.openGuildRecordDetails(params.row);
                    },
                  },
                },
                "公会记录"
              ...
              h(
                "el-button",
                {
                  props: { type: "danger" },
                  style: {
                    display: this.permissionArr.includes("Guild@rmGuildUser")
                      ? "unset"
                      : "none",
                  },
                  on: {
