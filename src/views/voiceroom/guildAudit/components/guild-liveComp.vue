              ...
              h(
                "el-button",
                {
                  ...
                  style: {
                    display:
                      params.row.status !== 3 &&
                      this.permissionArr.includes("Guild@updateLiveReplace")
                        ? "unset"
                        : "none",
                  },
                  on: {
              ...
              h(
                "el-button",
                {
                  ...
                  style: {
                    display:
                      params.row.status !== 3 &&
                      this.permissionArr.includes("Guild@updateLiveInfo")
                        ? "unset"
                        : "none",
                  },
                  on: {
                ...
                "el-button",
                {
                  ...
                  style: {
                    display:
                      params.row.status === 1 &&
                      params.row.status !== 3 &&
                      this.permissionArr.includes("Guild@updateLiveFreeze")
                        ? "unset"
                        : "none",
                  },
                  on: {
              ...
              h(
                "el-button",
                {
                  ...
                  style: {
                    display:
                      params.row.status !== 3 &&
                      this.permissionArr.includes("Guild@updateLiveDisband")
                        ? "unset"
                        : "none",
                  },
                  on: {
