		...
		<el-dialog :title="popTitle" :visible.sync="popFormVisible">
			<el-form :model="popForm" ref="popForm" :rules="popFormRules">
				<el-form-item label="序号" prop="sort" :label-width="formLabelWidth">
					<el-col :span="7">
						<el-input v-model="popForm.sort" v-input-limit="0" placeholder="输入序号范围: 1 ~ 65535"
							style="width: 235px;" clearable autocomplete="off" />
					</el-col>
				</el-form-item>
				<el-form-item label="类型名称" prop="name" :label-width="formLabelWidth">
					<el-col :span="7">
						<el-input v-model="popForm.name" style="width: 235px;" clearable autocomplete="off"
						 @change="inputChange($event)" />
					</el-col>
				</el-form-item>
				<el-form-item label="开始时间" prop="start_time" :label-width="formLabelWidth">
					<el-date-picker v-model="popForm.start_time" style="width: 235px;" type="date" placeholder="选择日期"
						clearable />
				</el-form-item>
			</el-form>
