  ...
  <div class="serviceConfig-audioTest-box">
    ...
    <div class="searchParams">
      <SearchPanel
        ...
        batch-func-name="批量审核通过"
        batchRurnName="批量审核误杀"
        @onReset="reset"
        @onSearch="onSearch"
        @export="handleExport"
        @batchPass="handleBatchPendingReview(2)"
        @BatchRurn="handleBatchPendingReview(3)"
      ></SearchPanel>
    </div>
...
// 引入api
import { exprotAudio } from "@/api/risk.js";
// 引入详情组件
        ...
        columns: [
          ...
          },
          {
            ...
            render: (h, params) => {
              return h(
                "span",
                params.row.operator ? params.row.operator : "--"
              );
            },
          },
          {
          ...
          },
          {
            ...
            width: "110px",
            render: (h, params) => {
              return h("div", [h("div", params.row.guild_name)]);
            },
          },
          {
            label: "用户当前状态",
            width: "110px",
            render: (h, params) => {
              return h("div", [h("div", params.row.punish_status)]);
            },
          },
          {
            label: "用户麦位",
          ...
          },
          {
            ...
            render: (h, params) => {
              return h("div", [
                h(
                  "div",
                  `${params.row.label || "--"}/${params.row.sub_label || "--"}`
                ),
              ]);
            },
          },
          {
            ...
            minWidth: "130px",
            render: (h, params) => {
              let data = MAPDATA.REVIEWSTATUSLIST.find((item) => {
              ...
              return h("div", [
                h(
                  "el-button",
                  {
                    ...
                    on: {
                      click: () => {
                        this.handleOperation("warn", params.row);
                      },
                    },
                  },
                  "警告"
                ...
                h(
                  "el-button",
                  {
                    ...
                    on: {
                      click: () => {
                        this.handleOperation("add", params.row);
                      },
                    },
                  },
                  "封禁"
                ...
                h(
                  "el-button",
                  {
                    ...
                    on: {
                      click: () => {
                        this.handleOperation2(2, params.row.id);
                      },
                    },
                  },
                  "通过"
                ...
                h(
                  "el-button",
                  {
                    ...
                    on: {
                      click: () => {
                        this.handleOperation2(3, params.row.id);
                      },
                    },
                  },
                  "误杀"
  ...
  methods: {
    ...
    beforeSearch(params) {
      ...
      return {
        ...
        operate_start_time: s.operate_start_time
          ? Math.floor(s.operate_start_time / 1000)
          : "",
        operate_end_time: s.operate_end_time
          ? Math.floor(s.operate_end_time / 1000)
          : "",
        ...
        if (res.data.type + "" === "excel") {
          ...
          arr = arr.map((item, index) => {
            ...
            let params = {
              start_time:
                item.start_time > 0
                  ? timeFormat(item.start_time, "YYYY-MM-DD HH:mm:ss", true)
                  : "--",
              operator_time:
                item.operator_time > 0
                  ? timeFormat(item.operator_time, "YYYY-MM-DD HH:mm:ss", true)
                  : "--",
